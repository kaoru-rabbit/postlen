...
export const homeJa: HomeContent = {
  sections: [
    {
      ...
      blocks: [
        {
          type: "p",
          text: "PostLenは、ひとつの下書きを8つの投稿先に対して同時にカウントし、それぞれでどう表示されるかを確認できます。一度入力すれば、上に並ぶすべてのプラットフォームのカードが各自の文字数上限、カウント規則に従って更新されます。",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "一般的な文字数カウンターは、リンク・絵文字・日本語を含むX向けの文章の文字数を誤って計算します。Postlenはそうではありません。",
        },
      ],
    },
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Xが重み付けカウントを採用しているためです。CJKの文字と絵文字は2単位、URLは一律23単位を消費します。",
    },
   
    
    {
      q: "入力した情報は安全ですか？",
      a: "安全です。すべてブラウザ内で動作し、下書きが外部に送信されることはありません。",
    },
    {
